...
x:0,opacity:1,duration:2,stagger:{amount:1},ease: "power3.out",
      ...
      const handleSearchChange = (event) => {
          ...
          // Implement your search logic here using the searchText state value
          // For instance, you might trigger a search API call with the searchText
      };
   ...
   const handleSearchClick = () => {
    ...
    // For instance, make an API call or filter data based on searchText
    navigate(`/products/${searchText}?filter=all`)
};
                    ...
                    <li class=" dropdown">
                        ...
                        <ul class="dropdown-menu" style={{ backgroundColor: "grey", border: "none", textAlign: "center" }}>
                            <li class="dropdown-item" >
                                ...
                                onClick={()=>{
                                    navigate('/products/national teams?filter=all')
                                }}
                                onMouseEnter={()=>{
                            ...
                            <li class="dropdown-item" ><a onClick={()=>{
                                    navigate('/products/teams?filter=all')
                                }} style={{  color: theme.palette.common.black   }}>TEAMS</a></li>

                        </ul>
                    </li>
                    <li >
                        <a href="/#abt" style={{  color: theme.palette.common.white   }}>
                            ABOUT US
                        </a>
  ...
  <ShoppingCartIcon style={{color:"white"}} onClick={()=>{
    navigate("/cart")
                ...
                <Search
            id='srchg'
            sx={{ border: "1px solid", color: 'white', borderColor: 'white' }}
        >
            ...
            />
            <IconButton sx={{color:"white"}} onClick={handleSearchClick} aria-label="search">
                <SearchIcon />
            </IconButton>
        </Search>
    ...
    navigate("/cart")
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    navigate("/")
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " style={{ color: theme.palette.common.white }} href="/#abt" >
                                ABOUT US
                            </a>
